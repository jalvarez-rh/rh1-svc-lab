...
You're going to run the following setup scripts for module 2,3 and 4 while you work on module 1.
...
./tssc-setup/run-all-setup.sh
./ai-setup/run-all-setup.sh
----

[NOTE]
====
You'll run the same script at the beginning of each module to verify that everything is working as expected.
====
