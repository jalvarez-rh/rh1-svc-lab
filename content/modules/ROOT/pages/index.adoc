...
Before proceeding with the lab modules, you'll need to configure kubectl contexts for the clusters, install a few insecure applications and the roxctl CLI tool.
