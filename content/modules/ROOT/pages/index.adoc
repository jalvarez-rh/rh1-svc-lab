...
Before proceeding with the lab modules, you'll need to configure kubectl contexts for the clusters, install a few insecure applciations and the roxctl CLI tool.
...
cd ~/rh1-svc-lab/lab-setup
./run-all-setup.sh
----

[TIP]
====
You can make sure you have access to the RHACS Central Service and OpenShift Console while you're waiting for the setup to complete. 
====
