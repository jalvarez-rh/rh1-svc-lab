...
image::01-create-cluster.png[link=self, window=blank, width=100%, Create Cluster]
...
image::02-aws-credentials.png[link=self, window=blank, width=100%, AWS Credentials]
...
image::03-create-cluster-details.png[link=self, window=blank, width=100%, Create Cluster Details]
...
image::04-create-cluster-nodepools.png[link=self, window=blank, width=100%, Create Cluster NodePools]
...
image::05-create-cluster-networking.png[link=self, window=blank, width=100%, Create Cluster Networking]
...
image::06-create-cluster-summary-create.png[link=self, window=blank, width=100%, Create Cluster Summary Page]

[start=15]
. Sit back and watch RHACM do it's thing. You should see the Cluster creation process starting in the UI.

image::07-cluster-creation.png[link=self, window=blank, width=100%, View New Cluster]
...
+
image::11-vm-name.png[link=self, window=blank, width=100%, Create VM]
+
NOTE: Please notice all of the available options to configure the VM with, these will change depending on your operating system
...
image::13-argoconfig.png[link=self, window=blank, width=100%, ArgoCD Config]
...
image::14-app-gitops.png[link=self, window=blank, width=100%, App GitOps]
...
image::15-app-gitops-2.png[link=self, window=blank, width=100%, App ACM GitOps]
...
image::16-app-gitops-3.png[link=self, window=blank, width=100%, App ACM GitOps]
...
image::17-app-placement.png[link=self, window=blank, width=100%, ACM App Placement]
...
image::18-application-topology-git.png[link=self, window=blank, width=100%, Application Topology]
...
image::19-application-route-git.png[link=self, window=blank, width=100%, Application Route]
