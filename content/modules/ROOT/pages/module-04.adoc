...
image::04-openshift-ai-dashboard-01.png[OpenShift AI Dashboard Login, width=100%]

[start=3]
. Once logged in, you'll see the OpenShift AI dashboard home page:

image::04-openshift-ai-dashboard-02.png[OpenShift AI Dashboard Home, width=100%]

[start=4]
. Navigate to the *Applications* -> *Enabled* section to see available components:

image::04-openshift-ai-dashboard-03.png[OpenShift AI Applications View, width=100%]
...
image::04-openshift-ai-dashboard-04.png[Create Jupyter Workbench, width=100%]
