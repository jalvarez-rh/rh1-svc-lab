...
.. Click *Open application* in the *Start basic workbench* tile
+
image::04-openshift-ai-dashboard-04.png[Create Jupyter Workbench, width=100%, link=self, window=blank]

. Configure your workbench:
.. Select *Jupyter | Data Science | CPU | Python 3.12 2025.2* for the Workbench image
.. Select `Medium` for the *Container Size*
...
. Once your notebook server is running, click *Open in a new tab* to access your Jupyter environment (if you get prompted to log in just use the admin credentials again):
+
